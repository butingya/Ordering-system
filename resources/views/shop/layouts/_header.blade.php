            ...
            <ul class="nav navbar-nav">
                        ...
                        <li>
                            ...
                            <ul class="menu">
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="/shop/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                                        </div>
                                        <h4>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="/shop/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                                        </div>
                                        <h4>
                                            Developers
                ...
                @auth("web")
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="{{route("shop.user.pwd")}}">修改密码</a></li>
                            <li><a href="{{route("shop.user.logout")}}">退出当前账号</a></li>
